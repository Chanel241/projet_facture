...
admin.site.site_title = _("Administration du système de facturation Hooyia")
admin.site.site_header = _("Administration du système de facturation Hooyia")
admin.site.index_title = _("Tableau de bord du système de facturation Hooyia")